...
typedef enum {vide, reine_rouge, reine_noire, ouvriere_rouge, ouvriere_noire, rouge_feuille, noire_feuille, rougeXP, noireXP, rougeXPfeuille, noireXPfeuille} t_classe_fourmi;
	...
	for(i=0;i<DIMX;i++){
		...
		for(j=0;j<DIMY;j++)
			switch(P[i][j]){
				...
				case reine_rouge: printf("RR"); break;
				case reine_noire: printf("RN"); break;					case ouvriere_rouge: printf("r "); break;
				case ouvriere_noire: printf("n "); break;
				case rouge_feuille: printf("r*"); break;
				case noire_feuille: printf("*n"); break;
				case rougeXP: printf("R "); break;
				case noireXP: printf("N "); break;
				case rougeXPfeuille: printf("R*"); break;
				case noireXPfeuille: printf("*N"); break;
				case MARE: printf("@@"); break;
				case FEUILLE: printf("* "); break;
				default: printf("!!");
			}		
		printf("|\n");		
	}
...
// A FAIRE: ecrire le corps de la fonction 
	...
	{
		switch (evolution(colonie, P, etat))
		{
		case -1:
			oter_elt(colonie);
			break;
		...
		case 1:
			...
			else ajout_droit(colonie, ouvriereNoire);
			break;
